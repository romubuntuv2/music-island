...
const Gamme1:IGamme = {
    color:'#3185FC',
    bells:[{name:"C3",duration:2}, {name:"D3",duration:2},{name:"E3",duration:2},{name:"G3",duration:2},{name:"A3",duration:2}],
    synth:[{name:"C3",duration:.5}, {name:"D3",duration:.5},{name:"E3",duration:.5},{name:"F3",duration:.5},{name:"G3",duration:.5},{name:"A3",duration:.5},{name:"B3",duration:.5}]
}
const Gamme2:IGamme = {
    color:'#d74cde',
    bells:[{name:"E3",duration:2}, {name:"G3",duration:2},{name:"A3",duration:2},{name:"B3",duration:2},{name:"D4",duration:2}],
    synth:[{name:"E3",duration:.5}, {name:"F#3",duration:.5},{name:"G3",duration:.5},{name:"A3",duration:.5},{name:"D3",duration:.5},{name:"C4",duration:.5},{name:"D4",duration:.5}]
}
...
export interface IMusicStore {
    ...
    changeNote:(note: IStep, index: number, type:'synth'|'bells') => void,
    setStepsByType:(note: IStep, index: number, type:'synth'|'bells') => void
    getBellsSteps:()=> (StepNoteType[]|null)[]
    getStepsByType:(type:'bells'|'synth')=> (StepNoteType[]|null)[]
    ...
    toggleGamme: () => void,
    getColor:()=> string,
    getDynamicNotes:(index:number,type:'bells'|'synth')=>StepNoteType
...
export const useMusicStore = create<IMusicStore>((set, get) => ({ 
    ...
    changeNote:(step:IStep, index:number, type:'synth'|'bells')=> {
        const {steps} =get();
    ...
    setStepsByType:(step:IStep, index:number, type:'synth'|'bells') => {
        const {steps} =get();
        // console.log(steps)
        const newSteps = steps
        const typedSteps = newSteps[type]
    ...
    getStepsByType:(type:'bells'|'synth') => {
        const {currentGamme, steps} = get()
    ...
    getDynamicNotes:(index:number,type:'bells'|'synth') => {
